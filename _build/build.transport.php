 ...
 */
/**
 * Build ActivationEmail Package
 *
 * Description: Build script for ActivationEmail package
 * @package activationemail
 * @subpackage build
 */
...
$sources= array (
    ...
    'docs' => $root . 'core/components/activationemail/docs/',
);
unset($root);
...
/* This section transfers every file in the local
 assets/mycomponents/activationemail/assets directory to the
 target site's assets/activationemail directory on install.
...
/* This section transfers every file in the local 
 assets/mycomponents/activationemail/core directory to the
 target site's core/activationemail directory on install.
 If the assets directory has been renamed or moved, they will still
 go to the right place.
 */
